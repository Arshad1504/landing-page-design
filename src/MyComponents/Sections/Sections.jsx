          ...
          <button
            id={
              activeSection === "section_1"
                ? "section_active_prev"
                : "section_inactive_prev"
            }
            onClick={() => {
              sectionAction("section_1");
            }}
          >
            HOME
          </button>
