import "./Home.css";
import TopBanner from "../../MyComponents/TopBanner/TopBanner";
...
import ProductCategoryCard from "../../MyComponents/ProductCategoryCard/ProductCategoryCard";
import CustomizationBanner from "../../MyComponents/CustomizationBanner/CustomizationBanner";
import DealsCarousel from "../../MyComponents/DiscountCard/DealsCarousel";
    ...
    <div className="Home_main">
      ...
      <div className="Home_main_flat_50_off">
        <DealsCarousel
          ...
          discount="75"
          data={DealsCarouselNewBornData}
        />
        <DealsCarousel
          title="DEALS ON BOYS CLOTHES"
          discount="35"
          data={DealsCarouselBoysData}
        />
        <DealsCarousel
          title="DEALS ON GIRLS CLOTHES"
          discount="85"
          data={DealsCarouselGirlsData}
        />
      </div>
    </div>
  );
